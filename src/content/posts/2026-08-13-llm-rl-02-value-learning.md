---
title: "大模型强化学习从零到面试（02）：价值学习——MC、TD 与 Q-learning"
description: "Bellman backup、TD error、SARSA/Q-learning 与 on/off-policy 的分界——回答数据复用类追问的地基。"
date: 2026-08-13
tags:
  - ai
  - llm
...
> 本文是《大模型强化学习：从零到面试》专题第 02 章的发布版，核验日期 2026-08-13。配套零依赖参考实现与自动测试托管在 GitHub 仓库 [llm-algo-job-notes](https://github.com/keepkeen/llm-algo-job-notes)。
