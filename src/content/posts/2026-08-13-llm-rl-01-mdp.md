---
title: "大模型强化学习从零到面试（01）：数学地基与 MDP"
description: "MDP 五元组、Bellman 方程、轨迹概率与 log-derivative trick——把语言模型写成策略的第一步。"
date: 2026-08-13
tags:
  - ai
  - llm
...
> 本文是《大模型强化学习：从零到面试》专题第 01 章的发布版，核验日期 2026-08-13。配套零依赖参考实现与自动测试托管在 GitHub 仓库 [llm-algo-job-notes](https://github.com/keepkeen/llm-algo-job-notes)。
