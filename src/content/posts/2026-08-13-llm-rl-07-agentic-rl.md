---
title: "大模型强化学习从零到面试（07）：Agentic RL 与多轮工具调用"
description: "多轮状态与 mask、六种信用分配方法（含 GiGPO 锚点状态分组）、过程奖励设计与终止条件。"
date: 2026-08-13
tags:
  - ai
  - llm
...
> 本文是《大模型强化学习：从零到面试》专题第 07 章的发布版，核验日期 2026-08-13。配套零依赖参考实现与自动测试托管在 GitHub 仓库 [llm-algo-job-notes](https://github.com/keepkeen/llm-algo-job-notes)。
