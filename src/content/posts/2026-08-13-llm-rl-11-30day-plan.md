---
title: "大模型强化学习从零到面试（11）：30 天学习与项目计划"
description: "四周从数学地基到可展示闭环的逐日计划，含题库分数门槛与项目最小可交付标准。"
date: 2026-08-13
tags:
  - ai
  - llm
...
> 本文是《大模型强化学习：从零到面试》专题第 11 章的发布版，核验日期 2026-08-13。配套零依赖参考实现与自动测试托管在 GitHub 仓库 [llm-algo-job-notes](https://github.com/keepkeen/llm-algo-job-notes)。
