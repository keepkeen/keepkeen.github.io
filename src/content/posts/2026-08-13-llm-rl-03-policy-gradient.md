---
title: "大模型强化学习从零到面试（03）：策略梯度、Actor-Critic 与 GAE"
description: "REINFORCE 推导、baseline 为什么不改变期望、GAE 的偏差—方差旋钮与 importance sampling。"
date: 2026-08-13
tags:
  - ai
  - llm
...
> 本文是《大模型强化学习：从零到面试》专题第 03 章的发布版，核验日期 2026-08-13。配套零依赖参考实现与自动测试托管在 GitHub 仓库 [llm-algo-job-notes](https://github.com/keepkeen/llm-algo-job-notes)。
