...
可运行思路和模式比较见 [`examples/on_policy_distillation`](https://github.com/THUDM/slime/blob/aaf5c2092b01219fa0d5c2d323741d409086ca32/examples/on_policy_distillation/README.md#mode-comparison) 与 [OPD 文档](https://github.com/THUDM/slime/blob/aaf5c2092b01219fa0d5c2d323741d409086ca32/docs/zh/advanced/on-policy-distillation.md#两种教师模式)。不要把示例结果外推到其他学生/教师、数据集和 KL 系数。
