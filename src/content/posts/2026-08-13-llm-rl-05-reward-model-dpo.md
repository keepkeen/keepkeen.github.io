---
title: "大模型强化学习从零到面试（05）：Reward Model、DPO 与偏好学习"
description: "Bradley–Terry 到 DPO 的完整推导、chosen/rejected 同降之谜、拒绝采样与 IPO/KTO/ORPO/SimPO 家族取舍。"
date: 2026-08-13
tags:
  - ai
  - llm
...
> 本文是《大模型强化学习：从零到面试》专题第 05 章的发布版，核验日期 2026-08-13。配套零依赖参考实现与自动测试托管在 GitHub 仓库 [llm-algo-job-notes](https://github.com/keepkeen/llm-algo-job-notes)。
